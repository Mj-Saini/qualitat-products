        ...
        <>
            <div className='relative h-[500px]'>
                ...
                <div className='absolute top-0 left-0 w-full h-full bg-gradient-to-t from-[#000000E5] to-transparent flex flex-col justify-end p-5'>
                    ...
                    <Link onClick={handleScrollTop} to={path}  className='flex items-center gap-2 py-2.5 capitalize font-semibold text-base lg:text-lg text-white cursor-pointer'>Explore More <span><ArrowIcons /></span></Link>
