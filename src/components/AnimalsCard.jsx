    ...
    return (
        <>
            <div className='relative h-[500px]'>
                <img className='w-full h-full object-cover' src={mapData.img || bullImg} alt="" />
                <div className='absolute top-0 left-0 w-full h-full bg-gradient-to-t from-[#000000E5] to-transparent flex flex-col justify-end p-5'>
                    <h3 className='text-xl lg:text-2xl font-semibold text-white leading-[160%]'>{mapData.full_name}</h3>
