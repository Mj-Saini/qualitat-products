           ...
           <section className='pb-14 md:pb-32 lg:pb-40 xl:pb-44 overflow-hidden'>
                <div className='custom_container container px-5 mx-auto get_in_touch_bg relative py-12 lg:py-24'>
                    ...
                    <div className='flex flex-col justify-center items-center z-10 relative'>
                      ...
                      <h2 className='font-semibold text-3xl md:text-5xl xl:text-6xl xl:leading-[120%] text-center py-3 text-white'>Get in Touch Today!</h2>
                      <p className='font-normal text-lg lg:text-xl text-white/90 leading-[160%] text-center'>For any inquiries, assistance, or to place an order, feel free to reach out to us</p>
                    
                       
                        <div className='mt-8 flex gap-5'>
                          <Link className='text-white font-semibold text-lg lg:text-xl flex items-center gap-2' to="tel:(123)456-789">
                              <span><DialIcons /></span>  (123)456-789</Link>
