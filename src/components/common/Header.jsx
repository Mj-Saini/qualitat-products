      ...
      <div className="px-5 lg:px-18 mx-auto flex gap-3  xl:gap-5 items-center justify-between py-4">
        {/* Logo */}
          ...
          <NavLink
            ...
            <NavLink onClick={()=>setToggle(false)} to="/genetics" className={` hover:text-[#C62524] text-sm text_stroke duration-300 transition-all ${location.pathname === '/products' ? 'text-black text_stroke_active' : 'text-black/70'}`}>
             Genetics
          </NavLink>
            <NavLink onClick={()=>setToggle(false)} to="/resources" className={` hover:text-[#C62524] text-sm text_stroke duration-300 transition-all ${location.pathname === '/products' ? 'text-black text_stroke_active' : 'text-black/70'}`}>
              Resources 
          </NavLink>
